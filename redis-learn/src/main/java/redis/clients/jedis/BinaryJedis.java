...
public class BinaryJedis implements BasicCommands, BinaryJedisCommands, MultiKeyBinaryCommands,
  ...
  public Map<byte[], byte[]> hgetAll(final byte[] key) {
    ...
    System.out.println(" hgetAll start:"+new Date(start));
    client.hgetAll(key);
    System.out.println(" hgetAll getBinaryMultiBulkReply:"+new Date(start));
    final List<byte[]> flatHash = client.getBinaryMultiBulkReply();
    long end = System.currentTimeMillis();
    System.out.println(" hgetAll end:"+new Date(end));
